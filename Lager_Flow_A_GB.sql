...
-- 
select a.Lager,count(a.[Order Date]) as "Sales Header", count(ssh.[Order Date]) as "Shipment Header" from (select esh.No_ as No_, LEFT(esh.[File No_],2) as Lager, sh.[Order Date] as "Order Date"
