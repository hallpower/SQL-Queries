...
select	ph.No_ as PO
		...
		, pl.No_ as SKU
		, pl.[Quantity Received] as Anzahl
...
join Urban_NAV600_SL.dbo.[Urban-Brand GmbH$eBayFFPurchaseLine] pl with (nolock)
	on pl.[Document No_] = ph.No_
		and pl.[Document Entry No_] = ph.[Entry No_]
...
where pl.[Document Entry No_] = ph.[Entry No_]
and ph.Type = 1
and ph.[Location Code] = 'BER_FIEGE'
and ph.[Posting Date] between '2014-12-01' and '2014-12-31'
),
we_adj as
(
...
--where malus_data.PO in ('BEST-1039413', 'BEST-1039360', 'BEST-1039115', 'BEST-1038288', 'BEST-1036307')
